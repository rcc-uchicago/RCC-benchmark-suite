...
These are taken from the  folder [bench](https://github.com/lammps/lammps/tree/develop/bench) under the LAMMPS source tree.
...
more than 80% up to 8 nodes. See [Thompson et al, Comput. Phys. Commun. 2022, 271, 108171](https://www.sciencedirect.com/science/article/pii/S0010465521002836)
